...
using PlayPort.Components.Audio;
...
namespace PlayPort.Creatures
{
    public class Creature : MonoBehaviour
    {
        ...
        protected PlaySoundsComponent SoundsComponent;
        ...
        protected virtual void Awake()
        {
            ...
            SoundsComponent = GetComponent<PlaySoundsComponent>();
        }
